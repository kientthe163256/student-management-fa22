...
public class CustomExceptionHandler {
    ...
    public ResponseEntity handleNoSuchElement(NoSuchElementException exception) {
        return new ResponseEntity(new ResponseDTO(exception.getMessage(), 404), HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity handleElementExisted(ElementAlreadyExistException exception) {
        return new ResponseEntity(new ResponseDTO(exception.getMessage(), 400), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity handleException(MethodArgumentTypeMismatchException ex) {
        ...
        return new ResponseEntity(new ResponseDTO(message, 400), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity handleMethodArgumentNotValid(MethodArgumentNotValidException ex) {
        ...
        return new ResponseEntity(new ResponseDTO(errors, 400), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity handleIllegalArgument(IllegalArgumentException ex) {
        return new ResponseEntity(new ResponseDTO(ex.getMessage(), 400), HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity handleDisabledException(DisabledException ex) {
        return new ResponseEntity(new ResponseDTO(ex.getMessage(), 403), HttpStatus.FORBIDDEN);
    }
    ...
    public ResponseEntity handleInvalidSortField(InvalidSortFieldException ex) {
        ...
        return new ResponseEntity(new ResponseDTO(errorMessage, 400), HttpStatus.BAD_REQUEST);
    }
}
